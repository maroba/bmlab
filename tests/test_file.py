...
from bmlab.file import BrillouinFile, BadFileException, is_source_file, is_session_file
...
def test_file_has_date():
    bf = BrillouinFile(data_file_path("Water.h5"))
    assert bf.date == datetime.datetime.fromisoformat("2020-11-03T15:20:30.682+01:00")
...
def test_file_get_repetition_date():
    ...
    assert rep.date == datetime.datetime.fromisoformat("2020-11-03T15:20:52.852+01:00")
...
def test_file_payload_get_date():
    ...
    assert date == datetime.datetime.fromisoformat("2020-11-03T15:21:10.568+01:00")
...
def test_file_calibration_get_date():
    ...
    assert date == datetime.datetime.fromisoformat("2020-11-03T15:21:07.484+01:00")
...
def test_file_calibration_get_binning():
    ...
    assert bf.get_repetition("0").payload.get_binning_factor("0") == 8
